...
| `20260513-1550` | medium | small | [passkey.js references csrfToken in create_user mode where the server does not check it](open/20260513-1550-passkey-js-csrftoken-create-user.md) |

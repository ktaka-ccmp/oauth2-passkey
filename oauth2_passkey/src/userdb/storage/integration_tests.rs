//! Integration tests for userdb storage module
//!
//! These tests verify UserStore behavior using the in-memory GENERIC_DATA_STORE
//! infrastructure to test real database interactions with proper isolation.

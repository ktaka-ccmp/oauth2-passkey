...
mod tests {
    ...
    // Test the expected schema for SQLite passkey table
    #[test]
    fn test_sqlite_passkey_schema() {
        // Get the expected schema columns from the validate_passkey_tables_sqlite function
        let expected_columns = vec![
            ("credential_id", "TEXT"),
            ("user_id", "TEXT"),
            ("public_key", "TEXT"),

...
mod tests {
    ...
    async fn test_validate_origin_mismatch() {
        ...
        match result {
            ...
            Ok(_) => {
                panic!("Expected InvalidOrigin error but got Ok");
            }
            Err(err) => {
                panic!("Expected InvalidOrigin error, got {:?}", err);
            }
        }
    }
    ...
    async fn test_get_token_from_store_not_found() {
        ...
        match result {
            ...
            Ok(_) => {
                panic!("Expected SecurityTokenNotFound error but got Ok");
            }
            Err(err) => {
                panic!("Expected SecurityTokenNotFound error, got {:?}", err);
            }
        }
    }
